{ *******************************************************
           CtComunicator - AZTelecom

         Desenvolvido por Daniel Jurado

   Proibida a reprodução total ou parcial do conteudo
         deste código fonte sem autorização.

         Unit uACSdefs_h - Constantes e tipos ACS

   Nesta unit estao traduzidas as constantes e tipos
   ACS obtidas do SDK e da documentacao TSAPI Avaya

        Ultima modificacao : 20/09/2005
  ******************************************************* }
unit uACSdefs_h;
